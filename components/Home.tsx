...
const Home: React.FC = () => {
    ...
    const cardIcons = {
        ...
        goals: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>,
    }
    ...
    return (
        <div className="w-full space-y-6 animate-fade-in stagger-in">
            ...
            <div className="grid grid-cols-2 gap-4" style={{ animationDelay: '200ms' }}>
                ...
                <HomeNavCard onClick={() => handleNavigateToMore('goals')} title={t('moreSpiritualGoals')} description={t('goalsDescription')} icon={cardIcons.goals} delay="400ms" />
            </div>
        </div>
    );
};
