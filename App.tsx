...
const translations: { [key in Language]: Translations } = {
  en: {
    ...
    liveDescription: "Listen and watch Islamic content.",
    liveRadio: "Radio",
    liveTv: "TV",
    liveSearchPlaceholder: "Search for a station...",
    livePlaying: "Now Playing",
    liveWatchNow: "Watch Now",
    liveLoadingStations: "Loading stations...",
    liveErrorStations: "Failed to load radio stations.",
    // Prayer Times
  ...
  ar: {
    ...
    moreLiveBroadcast: "بث مباشر",
    liveTitle: "بث مباشر",
    liveDescription: "استمع وشاهد محتوى إسلامي.",
    liveRadio: "إذاعة",
    liveTv: "تلفاز",
    liveSearchPlaceholder: "ابحث عن إذاعة...",
    livePlaying: "يتم التشغيل الآن",
    liveWatchNow: "شاهد الآن",
    liveLoadingStations: "جاري تحميل الإذاعات...",
    liveErrorStations: "فشل في تحميل قائمة الإذاعات.",
  ...
  fr: {
    ...
    liveDescription: "Écoutez et regardez du contenu islamique.",
    liveRadio: "Radio",
    liveTv: "TV",
    liveSearchPlaceholder: "Rechercher une station...",
    livePlaying: "En cours de lecture",
    liveWatchNow: "Regarder maintenant",
    liveLoadingStations: "Chargement des stations...",
    liveErrorStations: "Échec du chargement des stations de radio.",
